...
#ifndef UNDERSWIMMING_H
#define UNDERSWIMMING_H
...
class State_Underswimming : public FSMState {
public:
     ...
     */
    State_Underswimming(CtrlComponents* ctrlComp);
    virtual ~State_Underswimming(); // 添加默认析构函数
