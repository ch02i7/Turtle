#include "FSM/State_Underswimming.h"
#include <cmath>
#include <iomanip>


State_Underswimming::State_Underswimming(CtrlComponents *ctrlComp)
            : FSMState(ctrlComp, FSMStateName::UNDERSWIMMING, "underswimming"),
...
State_Underswimming::~State_Underswimming(){
    delete _gait;
}
 ...
 * 3. 重置步态生成器
 */
void State_Underswimming::enter(){
 ...
 * - 紧急停止时
 */
FSMStateName State_Underswimming::checkChange(){
 ...
 */
void State_Underswimming::getUserCmd(){
    /* 运动指令处理 */
 ...
 */
void State_Underswimming::calcCmd(){
    /* 平移运动处理 */
 ...
 */
void State_Underswimming::calcQQd(){
